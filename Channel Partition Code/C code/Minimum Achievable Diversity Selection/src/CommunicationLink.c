...
#ifndef achievable
    printf("This is the test for the diversity maximization channel selection scheme\n");
#endif
#ifdef achievable
    printf("This is the test for the minimum achievable diversity selection scheme\n");
    printf("The achievable diversity here is %d\n", x);
#endif
    printf("The algorithm is Sel_MMSE_OSIC\n");
...
#ifndef achievable
    fprintf(pfile , "Diversity Maximization Selection\n");
#endif
#ifdef achievable
    fprintf(pfile, "Minimum Achievable Diversity Selection\n");
    fprintf(pfile, "The minimum achievable diversity here is %d\n", x);
#endif
    fprintf(pfile, "Sel_MMSE_OSIC\n");
