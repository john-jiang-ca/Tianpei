...
SNR=[18:2:20];       %average receive signal to noie ratio (SNR) in (dB) 
...
fid=fopen('F:\GitHub\Tianpei\Channel Partition Code\Matlab\SEL-MMSE-OSIC\data\Sel_MMSE_OSIC.txt', 'a');
fprintf(fid, '\n');
fprintf(fid, '=========================================================================================\n');
fprintf(fid ,'this file test the correctness of Sel_MMSE_OSIC algorithm implementation in LS(large scale)-MIMO systems\n');
...
[symOut_sel_MMSE_OSIC]=sel_MMSE_OSIC(sigRec, H, SNRd(count)*Nt, M, pav, symConstell);   %Sel_MMSE-OSIC detection
