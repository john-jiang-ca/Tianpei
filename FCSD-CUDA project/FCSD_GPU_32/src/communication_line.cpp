...
#include "common.h"
#define BER "BER_48_4_0_12.txt"   //the file to store the bit error rate
#define SER "SER_48_4_0_12.txt"  //the file to store the symbol error rate
...
#define SNRnum 8                     //the point number of signal to noise ratio per bit
