/*
 * Lattice Reduction (D_SLV) aided Belief propagation MIMO decoder
 * 4 QAM modulation test
 * INPUT
 * preceived: received symbol vector
 * pH: propagation matrix
 * SNR:signal to noise ratio per bit in decimal
...
#include"common.h"
#define e 2.71828
D_SLV_LR_BP(preceived,pH,SNR,Nr,Nt,M,psymbolconstellation,symOut)
{
