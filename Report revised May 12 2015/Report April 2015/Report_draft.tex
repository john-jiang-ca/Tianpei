...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.6]{NtE1.eps}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth, height=5cm]{LogE_om_em1.eps}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth, height=5cm]{LogE_om_t1.eps}
...
Thus we have 
\begin{equation}
E[\ln(det(\mathbf{A}))]=\frac{\tilde{\Gamma}^{'}_{m}(n)}{\tilde{\Gamma}_{m}(n)}=\sum_{i=1}^{m}\psi(n-i+1),
\label{Appendequa8}
\end{equation}
...
\begin{equation}
f_{y_{i}}(\rho)=|\frac{dy_{i}}{dx_{i}}|^{-1}f_{x_{i}}(g^{-1}(\rho))=\frac{1}{\mathbb{B}(k_{1}^{i},k_{2}^{i})}e^{-k_{1}^{i}\rho}(1-e^{-\rho})^{k_{1}^{i}-1}.
\label{Appendequal14}
\end{equation}
