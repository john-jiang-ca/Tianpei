...
SNR=[4:2:26];       %signal to noise ratio (SNR) in (dB)
...
C=4;              %parameter to control the tradeoff between the penaty term of outliers and regularization term in SVR
...
ChannelRealization=3e3;  %the minimum number of channel realizations
...
[symOut_RSVD]=RSVD(H_r,  sigRec_r, SNRd(count),  M, pav, C, tol ,epsilon);  %RSVD detection
