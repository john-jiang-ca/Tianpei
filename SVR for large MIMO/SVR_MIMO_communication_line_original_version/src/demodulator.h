...
//	int M = psymbolconstellation->size;
//	int Nt1 = poutput->size;
//	for (count1 = 0; count1 < Nt1; count1++) {
//		for (count2 = 0; count2 < M; count2++) {
//			if (symOut[count1].x
