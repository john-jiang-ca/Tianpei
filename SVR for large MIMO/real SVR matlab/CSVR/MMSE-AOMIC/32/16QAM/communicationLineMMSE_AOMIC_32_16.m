...
SNR=[10:2:32];       %signal to noise ratio per bit in dB
...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/16QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
fprintf(fid_t, 'this is %d X %d MIMO\n', Nr, Nt);
fprintf(fid_t, '%d QAM modulation\n', M);
fprintf('\n');
fprintf(fid_t, 'The detectors tested are\n');
fprintf(fid_t, 'MMSE-AOMIC-SER1\n');
...
fid1=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/16QAM/data/SER1.txt','a');  %the file store the SER values
...
fprintf(fid1, 'symbol error rate of MMSE-AOMIC\n');
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/16QAM/data/README.txt', 'a');
