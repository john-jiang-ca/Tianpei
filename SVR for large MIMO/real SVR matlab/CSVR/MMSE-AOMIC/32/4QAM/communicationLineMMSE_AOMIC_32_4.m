...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/4QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
...
fid1=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/4QAM/data/SER1.txt','a');  %the file store the SER values
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-AOMIC/32/4QAM/data/README.txt', 'a');
