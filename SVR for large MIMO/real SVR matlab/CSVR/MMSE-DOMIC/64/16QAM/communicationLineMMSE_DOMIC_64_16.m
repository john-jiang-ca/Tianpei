...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-DOMIC/64/16QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
fprintf(fid_t, 'this is %d X %d MIMO\n', Nr, Nt);
fprintf(fid_t, '%d QAM modulation\n', M);
fprintf('\n');
fprintf(fid_t, 'The detectors tested are\n');
fprintf(fid_t, 'MMSE-DOMIC-SER1\n');
...
fid1=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-DOMIC/64/16QAM/data/SER1.txt','a');  %the file store the SER values
...
fprintf(fid1, 'symbol error rate of MMSE-DOMIC\n');
...
% [ symOut1 ] = MIC_ordering_ascend_Recursive(sigRec, H, sym_prev, SNRd(count), M, pav, stage, maxStage1,W,G, symConstell, order);
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE-DOMIC/64/16QAM/data/README.txt', 'a');
