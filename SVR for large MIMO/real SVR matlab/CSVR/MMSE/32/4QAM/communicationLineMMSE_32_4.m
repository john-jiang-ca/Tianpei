...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE/32/4QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/MMSE/32/4QAM/data/README.txt', 'a');
