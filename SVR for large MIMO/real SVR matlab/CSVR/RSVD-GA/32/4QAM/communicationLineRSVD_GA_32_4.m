...
SNR=[4:2:12];       %signal to noise ratio per bit in dB
...
%     hBER = comm.ErrorRate;
 fid=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD-GA/32/4QAM/data/BER_RSVD_GA.txt', 'a');
 fprintf(fid, '\n');
 fprintf(fid, '-----------------\n');
