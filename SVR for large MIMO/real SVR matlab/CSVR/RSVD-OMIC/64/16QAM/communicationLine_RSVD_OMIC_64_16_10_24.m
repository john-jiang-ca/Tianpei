...
SNR=[26:2:34];       %signal to noise ratio per bit in dB
...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD-OMIC/64/16QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
fprintf(fid_t, 'this is %d X %d MIMO\n', Nr, Nt);
fprintf(fid_t, '%d QAM modulation\n', M);
fprintf('\n');
fprintf(fid_t, 'The detectors tested are\n');
fprintf(fid_t, 'RSVD-OMIC-SER1\n');
...
fid1=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD-OMIC/64/16QAM/data/SER2.txt','a');  %the file store the SER values
...
[ symOut1 ] = RSVR_MIC_ordering_descend(sigRec, H, sym_prev, SNRd(count), M, pav, stage, maxStage1,W,G, symConstell, order);
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD-OMIC/64/16QAM/data/README.txt', 'a');
