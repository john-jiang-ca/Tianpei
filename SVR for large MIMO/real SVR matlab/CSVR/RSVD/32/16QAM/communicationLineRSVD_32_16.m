...
SNR=[38:2:42];       %signal to noise ratio per bit in dB
...
%     hBER = comm.ErrorRate;
 fid=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/32/16QAM/data/BER.txt', 'a');
 fprintf(fid, '\n');
 fprintf(fid, '-----------------\n');
