...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/32/16QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/32/16QAM/data/README.txt', 'a');
