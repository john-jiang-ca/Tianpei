...
SNR=[30:2:36];       %signal to noise ratio per bit in dB
...
%     hBER = comm.ErrorRate;
 fid=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/64/4QAM/data/BER.txt', 'a');
 fprintf(fid, '\n');
 fprintf(fid, '-----------------\n');
