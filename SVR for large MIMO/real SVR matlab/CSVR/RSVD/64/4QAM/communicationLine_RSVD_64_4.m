...
%% generate files
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/64/4QAM/data/README.txt','a');   %the file for explanations
fprintf(fid_t, '\n');
fprintf(fid_t, 'this is %d X %d MIMO\n', Nr, Nt);
fprintf(fid_t, '%d QAM modulation\n', M);
fprintf('\n');
fprintf(fid_t, 'The detectors tested are\n');
fprintf(fid_t, 'RSVD-SER1\n');
...
fid1=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/64/4QAM/data/SER1.txt','a');  %the file store the SER values
...
fprintf(fid1, 'symbol error rate of RSVD\n');
...
fid_t=fopen('/home/tchen44/code/Tianpei/SVR for large MIMO/real SVR matlab/CSVR/RSVD/64/4QAM/data/README.txt', 'a');
