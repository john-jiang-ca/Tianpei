function [ symOut ] = RSVD_GA( y, H, symGeneration_prev, M, symConstell, C, tol, epsilon, SNRd, pav, population, generation, maxGeneration )
...
alpha=0.8; %size of the population to do PIC
S_area=6; %searching area of the initial population
...
%% Next generation 
 [symOut]=RSVD_GA( y, H, symGeneration_current, M, symConstell, C, tol, epsilon, SNRd,pav, population, generation+1, maxGeneration );
