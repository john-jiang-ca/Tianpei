function [ symOut ] = RSVR_OMIC_MMSE(y, H, symOut_prev, SNRd, M, pav, stage, maxStage,W,G, symConstell, order,C, tol, epsilon)
...
% order=1:Nt;
E=zeros(M, 1);  %record the Euclidean distance 
...
%      [symOut_tmp(count)]=RSVR(H_tmp_r, y_tmp_r, SNRd, M, pav, 0.2);
...
[symOut]=RSVR_OMIC_MMSE(y, H, symOut_current, SNRd, M, pav, stage+1, maxStage, W,G, symConstell,order, C,tol, epsilon);
end
