...
MSE_training_svrV(count)=MSE_training_svr/realization; 
MSE_training_svr_coV(count)=MSE_training_svr_co/realization; 
MSE_training_mmseV(count)=MSE_training_mmse/realization;
MSE_training_mmse_coV(count)=MSE_training_mmse_co/realization;
MSE_testing_svrV(count)=MSE_testing_svr/realization;
MSE_testing_mmseV(count)=MSE_testing_mmse/realization;
end
