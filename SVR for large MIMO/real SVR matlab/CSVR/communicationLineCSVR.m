...
SNR=[10:2:22];       %signal to noise ratio per bit in dB
...
%% generate files
fid_t=fopen('README.txt','a');   %the file for explanations
...
fid1=fopen('SER1.txt','a');  %the file store the SER values
...
SER1(count)=symError1/(channelRealization*Nt);  %caculate symbol error rate of MMSE
