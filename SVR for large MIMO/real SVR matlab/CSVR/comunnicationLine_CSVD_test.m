...
fprintf(fid, 'C is %0.10f', C);
fprintf(fid, 'epsilon is %0.10f', epsilon);
...
% generation=0;
% [ symOut3 ] = MMSE_complex( sigRec, H, SNRd, M, pav );
...
% bitOut2=grayDecoder(symOut2, graycode, symConstell);
% bitError2=bitError2+checkBitError(bitOut2, grayData, M);
% end
% end
...
SER2(count)=symError2/(channelRealization*Nt);  %caculate symbol error rate of MIC
